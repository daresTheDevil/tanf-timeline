  ...
  <div class="bg-white">
    <header class="relative bg-blue-gray-800 pb-36">
      <div class="absolute inset-0">
        <img class="h-full w-full object-cover object-top" src="https://images.unsplash.com/photo-1511467134950-e3c968bf539d?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&h=800&q=80" alt="" />
        <div class="absolute inset-0 bg-green-800 mix-blend-multiply" aria-hidden="true" />
      </div>
